...
\label{sec:Theorie}
    ...
    Ein Halbleiter ist dotiert, wenn er gezielt mit Fremdatomen verunreinigt ist. Dotierung ist bei vielen Anwendungen von Halbleitern nötig, da die Ladungsträgerdichten des reinen Halbleitermaterials oft
    ...
    das chemische Potential im gesamten Material konstant sein muss. Dabei wird die Bandlücke durch die Verschiebung der Bänder an der Grenze also kleiner \cite[517]{gross_marx_2022}. 
    ...
    Richtung wird der fließende Strom mit steigender Spannung also größer, weshalb dies die Durchlassrichtung ist \cite[524-526]{gross_marx_2022}.
    \\
