...
\label{sec:Theorie}
    ...
    \subsection{Absorption und Emission elektromagnetischer Stahlung}
        ...
        \end{figure}
        \FloatBarrier\noindent
        Bei der \textbf{Absorption} trifft ein Photon mit der Energiedifferenz $\increment E$ der beiden Energieniveaus auf das Atom und regt so das Elektron von Energienivau $E_1$ in $E_2$ an.
    ...
    \subsection{Funktionsprinzip eines Lasers}
        ...
        \label{sec:systeme}
            ...
            Dabei befindet sich der Niveauübergang, der zum Lasen verwendet wird, immer zwischen dem Grundzustand und dem höchsten der vier Zustände. 
            Das System wird extern ins Energieniveau $E_3$ gepumpt, von wo aus es mit kurzer Lebensdauer in das Niveau $E_2$ relaxiert.
            Der Übergang $E_{21}$ ist langlebig und wird zum Lasen verwendet. 
            Nach der stimulierten Emission befindet sich das System anders als im Drei-Niveau-System noch nicht im Grundzustand. 
            Der letzte Übergang $E_{10}$ findet ebenfalls relaxierend statt und hat eine sehr kurze Lebensdauer.
