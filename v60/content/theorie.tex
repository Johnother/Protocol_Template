\section{Theorie}
\label{sec:Theorie}
    Die Funktionsweise des Diodenlasers basiert auf einer Vielzahl von theoretischen Grundlagen aus der Quantenmechanik, sowie Atom- und Festkörperphysik.
    ...
    \subsection{Kohärenz}
        Licht ist kohärent, wenn die eines Lichtstrahls in ihren Quantenzahlen übereinstimmen. \textbf{QUELLE}%reicht das nicht lol?
    ...
    \subsection{Absorption und Emission elektromagnetischer Stahlung}
        ...
        Dabei können sie durch Absorbtion sowie stimulierte und sponane Emission zwischen zwei Energieniveaus wechseln \cite[53]{haken_wolf_2004}. 
        ...
        \end{figure}
        \FloatBarrier\noindent
        Bei der \textbf{Absorption} trifft ein Photon mit der Energiedifferenz $\increment E=h \nu$ der beiden Energieniveaus auf das Atom und regt so das Elektron von Energienivau $E_1$ in $E_2$ an.
       ...
       % Ein auf die Materie treffendes Photon der Energie $\symup{h}\nu$ wechselwirkt mit dem Elektron $\Psi_1$, das sich im Energieniveau $E_1$ befindet.
        ...
        Dabei wird ein Photon der Energie $\increment E = h \nu$ emittiert und das Elektron fällt wieder in das niedrigere Energieniveau $E_1$.
        Dieser Prozess wird \textbf{spontane Emission} genannt \cite[149]{yariv_1991}.
        ...
        Da das zweite Photon ist dabei kohärent zu dem ersten. 
        Die Intensität verdoppelt sich dabei und ist somit proportional zur Intensität des stimulierenden Lichtes \cite[155]{yariv_1991}.
    ...
    \subsection{Funktionsprinzip eines Lasers}
        ...
        \subsubsection{Besetzungsinversion}
            ...
            Diese liegt vor, wenn mehr Elektronen im energetisch höheren Zustand sind, als im niedrigeren. 
            Dies ist im thermischen Gleichgewicht nicht der Fall \cite[288-289]{möller_2003}. 
            Besetzungsinversion muss somit durch einen Pumpprozess erreicht werden. \textbf{QUELLE bitte}
        ...
        \label{sec:systeme}
            ...
            \\
            Daraus ergibt sich die Konsequenz, für Laseremission ein System im mehr als zwei Niveaus vorliegen muss. %dass die Besetzungsinversion im aktiven Medium durch einen anderen physikalischen Prozess ausgelöst werden muss, als jener, der bei der stimulierten Emission ausgenutzt wird.
            ...
            Dabie befindet sich der Niveauübergang, der zum Lasen verwendet wird, immer zwischen dem Grundzustand und dem höchsten der vier Zustände. Das System wird extern in den Zustand $\Psi_3$ gepumpt, von wo aus es mit kurzer Lebensdauer in den Zustand $\Psi_2$ relaxiert.
        ...
        \label{sec:resonator}
            ...
            Damit der Laserstrahl also die gewünschte Wellenlänge hat, muss die Länge des Resonators entsprechend abgestimmt werden. 
            ...
            Dabei ist allerdings entscheidend, dass die Verstärkung des Lasers größer ist, als die Verluste durch das Auskoppeln \cite[255]{svelto_1998}. \textbf{PASST DAS SO MIT QUELLE?}
