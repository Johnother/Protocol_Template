...
\label{sec:Theorie}
    ...
    \subsection{Bandstruktur und Halbleiter}
        ...
        Halbleiter sind diejenigen Materialien, bei denen die Fermi-Energie innerhalb der Bandlücke liegt. 
        Bei Halbleitern ist die Bandlücke aber klein (etwa $2-\qty{5}{\electronvolt}$), sodass sie schon ab Raumtemperatur Strom leiten können \cite[147 f.]{gross_marx_2022}. \textbf{PASSt QUelle noch?}
    ...
    \subsubsection{Dotierung eines Halbleiters}
        ...
        %zu gering sind. 
        Bei dem Material der Verunreinigung wird zwischen Donatoren und Akzeptoren unterschieden. Für Halbleiter der IV. Hauptgruppe werden als Donatoren Elemente der V. Hauptgruppe verwendet, 
        ...
        Ist ein dotierter Halbleiter hauptsächlich mit Donatoren dotiert, so wird er n-dotiert genannt. Ist er hauptsächlich mit Akzeptoren dotiert, wird er p-dotiert gennant \cite[503-506]{gross_marx_2022}.
    ...
    Liegt am p-n-Übergang so eine Spannung an, dass an der n-dotierten Schicht der Pluspol anliegt, wird die Raumladungszone an der Grenze
    größer, wodurch die Spannung an der Grenze abfällt, da bei steigender Spannung der Stromfluss abnimmt. Dies ist die Sperrrichtung der Dioden. 
    ...
    \\
    Eine solche Halbleiterdiode kann als nach dem Prinzip eines wie in Unterabschnitt \ref{sec:systeme} beschriebenen Vier-Niveau-Systems Photonen emittieren. 
    Dabei entspricht das Valenzband in der p-dotierten Schicht dem Grundzustand beim 
    Vier-Niveau-System. 
    Liegt an der Diode eine Spannung in Durchlassrichtung an, so verschieben sich die Fermienergien der beiden Schichten und es gelangen Elektronen ins Leitungsband der 
    ...
    Vier-Nivau-Systems. 
    Es entsteht hier durch die anliegende Spannung die für Laseraktivität benötigte Besetzungsinversion zwischen Grundzustand und höchstem Zustand. 
    Dies wird in \autoref{fig:pnjunciton} verdeutlicht. 
    Die Löcher und Elektronen relaxieren in Richtung der Grenze, wo sie anschließend miteinander rekombinieren und dabei Photonen mit einer Energie aussenden, 
    ...
    Damit es zu Laseraktivit kommen kann bzw. die Diode in ihre Laserphase übergehen kann, muss die Emission, wie in Unterabschnitt \ref{sec:resonator} erläutert, in einem Resonator 
    befinden. Nur so kann es zu stimulierter Emission und Lasing kommen. Dazu gibt es innerhalb des Halbleiterchips einen Streifen, welcher als optischer Resonator dient.
    ...
    verstärkt werden, direkt von der Temperatur abhängig. In der Vertikalen wird das Licht innerhalb des Streifens gehalten, dass der Brechungsindex der aktiven Schicht höher ist als der 
    ...
    Dieses reflektiert die nullte Beugungsordnung und damit ca $15\%$ des Strahls zurück in den Diodenchip. Dadurch wird abhängig vom Gitterwinkel 
