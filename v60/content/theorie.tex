...
\label{sec:Theorie}
    ...
    \subsection{Absorption und Emission elektromagnetischer Stahlung}
       ...
       % Ein auf die Materie treffendes Photon der Energie $\symup{h}\nu$ wechselwirkt mit dem Elektron $\Psi_1$, das sich im Energieniveau $E_1$ befindet.
        ...
        Das einfallende und emittierte Photon besitzen die gleiche Frequenz, Phase und Ausbreitungsrichtung.
        Das Licht ist kohärent, was eine grundlegende Eigenschaft von Laserlicht ist~\cite[31]{eichler_2015}.
