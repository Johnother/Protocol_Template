...
\label{sec:Theorie}
    ...
    \subsection{Funktionsprinzip eines Lasers}
        ...
        \label{sec:resonator}
            Zwei parallele Spiegel an den beiden Enden des aktiven Mediums reflektieren die axial emittierten Photonen durch das aktive Medium und lösen dort erneut stimulierte Emission aus.
            ...
            %    \label{eqn:resontor}
            %\end{equation}
            %genügen \cite{leifi_stehende_welle}. 
            ...
            Einer der Spiegel hat einen Refletionsgrad von $R\approx\qty{100}{\percent}$, der andere ist teildurchlässig mit $R < \qty{100}{\percent}$.
            Durch diesen wird das Laserlicht ausgekoppelt.
            \\
            Es ist entscheidend, dass die Pumpleistung des Lasers größer ist, als die Verluste durch das Auskoppeln aus dem Resonator, da die Laseraktivität sonst zusamenbricht~\cite[41 f.]{eichler_2015}. %\textbf{PASST DAS SO MIT QUELLE?} Jetzt Ja
