...
\label{sec:Theorie}
    ...
    \subsection{Absorption und Emission elektromagnetischer Stahlung}
        ...
        \begin{equation}
            \symup{\Delta}E = E_2 - E_1 = h f\,\mathrm{.}
            \label{eqn:planck}
        \end{equation}
        Dabei ist $\symup{h}$ das Planck'sche Wirkungsquantum und $f$ die Frequenz des Photons, dessen Energie der Energiedifferenz des Übergangs entspricht.
        \\
        ...
        \end{figure}
        \FloatBarrier\noindent
        Bei der \textbf{Absorption} trifft ein Photon mit der Energiedifferenz $\increment E=h f$ der beiden Energieniveaus auf das Atom und regt so das Elektron von Energienivau $E_1$ in $E_2$ an.
       ...
       % Ein auf die Materie treffendes Photon der Energie $\symup{h}\nu$ wechselwirkt mit dem Elektron $\Psi_1$, das sich im Energieniveau $E_1$ befindet.
        ...
        Dabei wird ein Photon der Energie $\increment E = h f$ emittiert und das Elektron fällt wieder in das niedrigere Energieniveau $E_1$.
    ...
    \subsection{Funktionsprinzip eines Lasers}
        ...
        \subsubsection{Besetzungsinversion}
            ...
            Besetzungsinversion muss somit durch einen Pumpprozess erreicht werden \cite[400]{haken_wolf_2004}.% \textbf{QUELLE bitte}
