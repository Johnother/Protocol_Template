...
\label{sec:Theorie}
    ...
    \subsection{Kohärenz}
        Die Quantenmechanik liefert mathematisch fundiert die Erkenntnis, dass das Photon, welches bei der stimulierten Emission frei wird, die gleiche Phasenbeziehung, Ausbreitungsrichtung und Frequenz hat wie das einfallende, induzierende Photon.
        ...
        Die zeitliche Kohärenz kann über die Kohärenzlänge quantifiziert werden. Bei Lassern liegt sie im Bereich von $\qty{300000}{\kilo\meter}$.
    \subsection{Funktionsprinzip eines Lasers}
        ...
        \subsubsection{Drei- und Vier-Niveau-Systeme}
            Ein Zwei-Niveau-System, wie es in \autoref{fig:atomspektrum} zur Veranschaulichung genutzt wird, ist nicht in der Lage, Laserlicht über stimulierte Emission zu erzeugen.
            ...
            \\
            Beim Drei-Niveau-System pumpt ein externer physikalischer Prozess das System vom Grundzustand $\Psi_0$ in einen Zustand $\Psi_2$, sodass die Energiedifferenz $\symup{\Delta}E_{21}$ größer ist als die Energiedifferenz, auf der die spontant Emission betrieben werden soll.
            ...
            \\
            Beim Vier-Niveau-System befindet sich der Niveauübergang, der zum Lasen verwendet wird, immer zwischen dem Grundzustand und dem höchsten der vier Zustände. Das System wird extern in den Zustand $\Psi_3$ gepumpt, von wo aus es mit kurzer Lebensdauer in den Zustand $\Psi_2$ relaxiert.
            Der Übergang $\Psi_21$ ist langlebig und wird zum Lasen verwendet. Nach der stimulierten Emission befindet sich das System anders als im Drei-Niveau-System noch nicht im Grundzustand. Der letzte Übergang $\Psi_10$ findet ebenfalls relaxierend statt und hat eine sehr kurze Lebensdauer.
        ...
        \subsubsection{Resonatoren}
            ...
            Dort stabilisiert sich der Laser, sodass die Besetzungsinversion und die stkimulierte Emission im Gleichgewicht liegen. Spontane Emission sollte nicht mehr stattfinden, weshalb die Zeit zwischen Anregung und Emission möglichst kurz sein sollte.
            Um die kohrenten Photonen möglichst lange im Medium zu halten, werden an beiden Enden des Mediums Spiegel angebracht. Die Elektromagnetische Strahlung bildet dann stehende Wellen, die der Bedingung
            \begin{equation}
                \symbf{Wellenbedingung einfügen!!!}
            \end{equation}
            genügen. Eine solche Anordnung von Spiegeln heißt \textbf{Resonator}.
            \\
            Damit die Laserstrahlung im Resonator stehende Wellen bilden kann, ist also die Resonatorlänge entscheidend.
            Da die Wellenlänge des Laserlichts in der Regel im oberen Nanometer-Bereich liegt, haben schon kleine Änderungen der Resonatorlänge einen großen Einfluss auf die Stabilität des Lasers.
            Allerdings bedeutet die kurze Wellenlänge ebenso, dass auch bei Resonatorlängen im Mikrometer-Bereich 
            ...
            Durch diesen Spiegel werden in etwa $XXX\%$ des Laserlichts aus dem Resonator gelassen und dem weiteren Strahlengang des Lasers zugeführt.
            \\
    ...
    der umliegenden Schichten. In der Transversalen sind ebenfalls Barrieren mit geringerem Brechungsindex. Die Periodizität der Verstärkung berechnet sich nach $\increment v_{\mathrm{FSR}}=\frac{c}{2Ln}$
    ...
    Bei unterschiedlich langen Seiten des Rechtecks ergibt sich daher ein elliptischer Transversalschnitt des Laserstrahls nach der Beugung \cite[000]{XXX}.
    \\
    ...
    \autoref{sec:halbleiterchip} beschriebene allgemeine Verstärkung des Materials. Der interne Resonator aus \autoref{sec:internalcavity} wird durch "Internal Cavity" dargestellt 
    und der äußere Resonator aus \autoref{sec:externalcavity} durch "External Cavity". Die schmale Verstärkung der Gitter-Rückkopplung aus \autoref{sec:gratingfeedback} ist durch
