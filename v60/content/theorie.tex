...
\label{sec:Theorie}
    ...
    \\
    Liegt eine Spannung in Durchlassrichtung an, so verschieben sich die Fermienergien der beiden Schichtne und es gelangen Elektronen ins Leitungsband der p-Dotierten Schicht und Löcher ins 
    Valenzband der n-dotierten Schicht. Dadurch entsteht hier die für Laseraktivität benötigte Besetzungsinversion \cite[396 f.]{svelto_1998}. Dies wird durch \autoref{fig:pnjunction} deutlich. 
    Die Löcher und Elektronen relaxieren dann in Richtung der Grenze, wo sie anschließend miteinander Rekombinieren und dabei Photonen mit einer Energie aussenden, die etwa der Bandlücke entspricht.
    DAs Grundprinzip ist hier also wie bei einem in Unterabschnitt \ref{sec:systeme} beschriebenem Vier-Niveau-System. 
    ...
    \begin{figure}
      ...
      \end{figure}
    Das Herzstück des verwendeten Diodenlasers ist ein Halbleiterchip mit mehreren Schichten. So können hier in der aktiven Schicht Elektron-Loch-Paare rekombinieren und senden dabei ein Photon aus \cite{V60}. Dieses
