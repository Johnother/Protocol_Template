...
Die relativen Abwichungen der Messergebnisse in diesem Abschnitt werden mit \autoref{eqn:relabw} berechnet.
\\\\
...
\autoref{fig:ring_fit} zeigt eine lineare Proportionalität zwischen Ringdicke und Frequenzabstand der entarteten Resonanzen, die nahe an den Messwerten liegt.
...
Eine mögliche Fehlerquelle ist, dass der $\qty{9}{\milli\meter}$-Ring aus dem $\qty{3}{\milli\meter}$- und dem $\qty{6}{\milli\meter}$-Ring zusammengesetzt ist.
...
\noindent
Die hochaufgelöste Vermessung der $\qty{6}{\milli\meter}$-Aufspaltung zeigt, dass die Entartung die Quantenzahl $l$ ändert, aber $m$ konstant bleibt.
