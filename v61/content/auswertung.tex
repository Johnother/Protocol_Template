...
\label{subsec:well}
Die Ergebnisse der Messung der Beugungsmaxima sind in für das Gitter mit $\qty{80}{\per\milli\meter}$ Gitterlinien sind in \autoref{tab:gitter80} und die für das Gitter mit $\qty{100}{\per\milli\meter}$ Gitterlinien in \autoref{tab:gitter100} aufgetragen. 
Daraus wird jeweils das größte Beugungsmaximum als Hauptmaximum identifiziert. 
Für das Gitter mit $\qty{80}{\per\milli\meter}$ Gitterlinien ergibt sich das Maximum bei $x=\qty{6.6}{\milli\meter}$ udn für das Gitter mit $\qty{100}{\per\milli\meter}$ Gitterlinien ergibt sich das Maximum bei $x=\qty{11.3}{\milli\meter}$
...
Daraus ergeben sich nach \autoref{eqn:mittelwert}
