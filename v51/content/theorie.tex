...
\begin{figure}
    ...
    \label{fig:schalt1}
\end{figure}
Bei einer anliegenden Wechselspannung ist die Bandbreite endlich, wie bereits in autoref{sec:Theorie} erwähnt. 
Es wird also erwartet, dass ab einer Grenzfrequenz $f_{\mathrm{G}}$ die Verstärkung wieder abnimmt. 
...
Liegt hier am Eingnag eine Wechselstromspannung an, dann ergibts sich aus der Gleichung mit \autoref{eqn:verstaerkung} der Zusammenhang
\begin{equation}
    A \propto \frac{1}{f}
    \label{equ:fint}
\end{equation}
...
Hierbei ergibt sich bei Anliegen einer Wechselstromspannung aus der Gleichung mit \autoref{eqn:verstaerkung} nun allerdings 
\begin{equation}
    A \propto f
    \label{equ:fdiff}
\end{equation}
