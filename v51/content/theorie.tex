...
Die hier anliegende Spannungsdifferenz wird verstärkt und wiederum am Ausgang ausgegeben. 
...
Die Steckplätze 2 Inverting Input und 3 Non-Inverting Input sind, wie es deren Namen deutlich machen, der invertierende und nicht-invertierende Eingang. 
...
Ist aber die theoretisch erreichte Ausgangsspannung größer als die Versorgungsspannung, steigt die Ausgangsspannung nicht weiter, sondern bleibt auf ihrem maximalen Wert.
...
Diese sorgt wiederum dafür, dass die Verstärkung des Operationsverstärkers abflacht, da durch die Kopplung des Ausgangs an den invertierenden Eingang, die Spannungsdifferenz am Eingang verringert wird.
...
\end{equation}
für die Grenzfrequenz gelten.
\\
Die Grenzfrequenz ist dabei der Bandbreite gleichzusetetzen. 
Da diese proportional zur Verstärkung wächst muss dabei
\begin{equation}
...
Hierbei ist anstelle von zwei Widerständen ein Widerstand und ein Kondensator verbaut.  
\begin{figure}
    \centering
...
Somit ist zu erkennen, dass die Schaltung tatsächlich das Eingangssignal integriert. 
