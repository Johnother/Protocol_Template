...
Diese Grenzfrequenz ist als diejenige Frequenz definiert, bei der die Verstärkung noch $70,7 \%$ \cite{electronicstutorials} also etwa dem $\sqrt{2}$ fachen der maximalen Verstärkung $V_{\mathrm{max}}$ entspricht. 
Es muss daher
\begin{equation}
