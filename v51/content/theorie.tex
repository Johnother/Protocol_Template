...
\begin{equation}
    \frac{U_{\mathrm{a}}}{U_{\mathrm{e}}} \propto \frac{1}{f}
    \label{equ:fint}
\end{equation}
zwischen dem Verhältnis von Ein- und Ausgangsspannung und der Frequenz $f$ des Eingangssignals.
...
\begin{equation}
    \frac{U_{\mathrm{a}}}{U_{\mathrm{e}}} \propto f
    \label{equ:fdiff}
\end{equation}
...
Dabei hat die Schaltung aufgrund dieses Kippverhaltens als Kennlinie eine sogenannte Hysterese, wie sie in \autoref{fig:hysterese} zu erkennen ist. 
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{content/images/schalt4.png}
    \caption{\textbf{NOCH EINFUEGEN} \cite{haas_2022}.}
    \label{fig:hysterese}
\end{figure}
