...
\\
Bei der ersten Messreihe werden die Widerstände $R_1 = \qty{10}{\kilo\ohm}$ und $R_2 = \qty{100}{\kilo\ohm}$ verwendet. Die gegeneinander aufgetragenen Messwerte zeigt \autoref{fig:lin1}. 
\begin{figure}
  \centering
...
\begin{align}
  A_{\mathrm{lin}} &= \qty{5.2(0.9)e4}, \\
  b_{\mathrm{lin}} &= \qty{-0.898(0.017)e-3}{}.
\end{align}
...
\begin{equation}
  f_{\mathrm{G}} = \qty{22(6)}{\kilo\hertz}\,\mathrm{.}
\end{equation}
Das Bandbreitenprodukt ergibt sich aus der Grenzfrequenz und der maximalen Verstärkung aus \autoref{eqn:bandbreitenprodukt}. 
