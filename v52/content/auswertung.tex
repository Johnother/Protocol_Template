...
\begin{figure}[ht]
    ...
    \begin{subfigure}{0.45\textwidth}
        ...
        %\label{fig:imp}
    \end{subfigure}
    \caption{Graphische Darstellung der Leitungskonstanten des Koaxialkabels abhängig von der Frequenz $\omega$, wobei $R$ der Ohmsche Belag, $I$ der Induktivitätsbelag, $C$ der Kapazitätsbelag und $\left|Z\right|$ die Impedanz ist.}
