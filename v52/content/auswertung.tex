...
$\Gamma_{-1}$ ist der Reflexionsfaktor am Übergang vom $\qty{75}{\ohm}$ Kabel zum $\qty{50}{\ohm}$ Kabel, $\Gamma_1$ der am Übergang in die andere Richung 
...
\begin{align}
    ...
    U_4 &= \Gamma_{-1}^2 \Gamma_2^3 \left(1-\Gamma_1\right)^2 U_0 \label{eqn:u4} \, .
\end{align}
